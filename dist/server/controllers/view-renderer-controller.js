...
router.get('/callback', (0, _wrap2.default)(regeneratorRuntime.mark(function _callee2(req, res, next) {
    var code, state, accessToken, patient, _req$query2, _ref, result, html;
        ...
        while (1) {
            switch (_context2.prev = _context2.next) {
                ...
                case 6:
                    ...
                    _context2.next = 13;
                    return (0, _httpService.get)(Constants.OBSERVATIONS_FETCH_URL, new Records.auth({ Authorization: 'Bearer ' + accessToken }));
